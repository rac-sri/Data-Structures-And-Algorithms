...
public static void main(String[] args) {
    ...
    while(!s1.empty())
    {
        ...
        a=s2.peek();
            ...
            else if(b>9 && a<10 &&(Math.abs(a-b/10)==1 || Math.abs(a-b%10)==1))
            {
            x=b/10;
            y=b%10;
            s1.pop();
            ...
            else if(a>9 && b>9 && (Math.abs(a/10-b%10)==1 || Math.abs(b/10-a%10)==1))
            {
                s1.pop();
                s2.pop();
        ...
        else if(s2.peek()>s1.peek())
        {
            ...
            else if(a<10 && b>9 &&(Math.abs(a-b/10)==1 || Math.abs(a-b%10)==1))
            {
                x=b/10;
                y=b%10;
                s1.pop();
